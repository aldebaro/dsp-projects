'''
This version supports variable dimension arrays. Frequency dimension is fixed,
but the time dimension varies according to the duration of the corresponding wav file.
...
def train(X, y, label_dict, out_folder="output", perc_test=0.2, 
        ...
        triplet_epochs = 140, num_classes = 8):
    print("######### General info #########")
    ...
    if True:   
        ...
        for i in range(0, super_epochs):               
            ...
            if True: #disable if do not want to train via triplets
                ...
                siamese = train_triplets(enc, by_label, WINDOW_PARAM, num_random_triplets, epochs=triplet_epochs)
...
if __name__ == '__main__':
    ...
    if args.output_dir == None:
        ...
        output_folder = os.path.join(os.path.dirname(input_folder), "encoder_models")
    else:
    ...
    train(X_train, y_train, label_dict, out_folder=output_folder,
        ...
        triplet_epochs=triplet_epochs, num_classes = num_classes)
