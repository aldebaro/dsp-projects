...
PATH = Path("./dataset/mit-bih-arrhythmia-database-1.0.0")
sampling_rate = 360
...
if __name__ == "__main__":
    ...
    wget.download(dataset_url, './dataset')

    print('Extracting files...')
    with ZipFile('./dataset/mit-bih-arrhythmia-database-1.0.0.zip', 'r') as zipObj:
